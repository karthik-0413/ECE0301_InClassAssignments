...
int main()
{
	...
	if((user7 == "v" || user7 == "V") && (user == "P" || user == "p") && (user2 == "c" || user2 == "C"))
	{
		...
		//Declaring variables in order to calculate the inner product of the vectors
		double innerProduct1, innerProduct2;
	
		//Using the formula given (R1*R2*cos(Theta1 - Theta2)), I calculated the inner product for the polar coordinates
		innerProduct1 = (num1 * Radius2) * cos(num2 - Theta2);
		cout << "\nThe inner product of v1 and v2 using polar coordinates is " << innerProduct1 << endl;
		
		//Using the formula given (x1x2 + y1y2), I calculated the inner product for the Cartesian coordinates
		innerProduct2 = (num3 * x) + (num4 * y);
		cout << "The inner product of v1 and v2 using Cartesian coordinates is " << innerProduct2 << endl;
	...
	else if (((user7 == "v" || user7 == "V") && (user == "P" || user == "p") && (user2 == "p" || user2 == "P")))
	{
		...
		//Using the formula given (R1*R2*cos(Theta1 - Theta2)), I calculated the inner product for the polar coordinates
		innerProduct1 = (num1 * num3) * cos(num2 - num4);
		cout << "\nThe inner product of v1 and v2 using polar coordinates is " << innerProduct1 << endl;
		
		//Using the formula given (x1x2 + y1y2), I calculated the inner product for the Cartesian coordinates
		innerProduct2 = (x2 * x) + (y2 * y);
		cout << "The inner product of v1 and v2 using Cartesian coordinates is " << innerProduct2 << endl;
	}
	...
	else if (((user7 == "v" || user7 == "V") && (user == "C" || user == "c") && (user2 == "p" || user2 == "P")))
	{
		...
		//Using the formula given (R1*R2*cos(Theta1 - Theta2)), I calculated the inner product for the polar coordinates
		innerProduct1 = (num3 * Radius) * cos(Theta - num4);
		cout << "\nThe inner product of v1 and v2 using polar coordinates is " << innerProduct1 << endl;
		
		//Using the formula given (x1x2 + y1y2), I calculated the inner product for the Cartesian coordinates
		innerProduct2 = (num1 * x2) + (num2 * y2);
		cout << "The inner product of v1 and v2 using Cartesian coordinates is " << innerProduct2 << endl;
	}
	...
	else if (((user7 == "v" || user7 == "V") && (user == "C" || user == "c") && (user2 == "c" || user2 == "C")))
	{
		...
		//Using the formula given (R1*R2*cos(Theta1 - Theta2)), I calculated the inner product for the polar coordinates
		innerProduct1 = (Radius * Radius2) * cos(Theta - Theta2);
		cout << "\nThe inner product of v1 and v2 using polar coordinates is " << innerProduct1 << endl;
		
		//Using the formula given (x1x2 + y1y2), I calculated the inner product for the Cartesian coordinates
		innerProduct2 = (num3 * num1) + (num4 * num2);
		cout << "The inner product of v1 and v2 using Cartesian coordinates is " << innerProduct2 << endl;
	}
	//Making an if-else statement to see if the user entered numbers for a polar coordinate or cartesian coordinate both times and to see if they want to represent vector or complex numbers.
	...
	{
		//Displaying both pairs of numbers in both cartesian and polar form formatted for vectors
		//Making an if-else loop to make sure negative numbers are displayed correctly
		if (num2 > 0)
		{
		...
		//Declaring variables in order to calculate the inner product of the vectors
		double product1, product2, product3, product4, product5, product6;
		
		//Finding the product using polar values
		product3 = Radius * Radius2;			// Two Radius Values
		product4 = Theta + Theta2;			// Two Theta Angles
		cout << "\nProduct, polar:\t\t z1 * z2 = " << product3 << " exp(j " << product4 << endl;
		
		//Finding the product using Cartesian values
		product1 = ((num1 * num3) - (num2 * num4));		//z1*z2 = (x1x2 - y1y2) + j(x1y2 + y1x2)
		product2 = ((num1 * num4) + (num2 * num3));
		
		//Making an if-else loop to make sure negative numbers are displayed correctly
		if (product2 > 0)
		{
			cout << "Product, Cartesian:\t z1 * z2 = " << product1 << " + j " << product2 << endl;
		}
		else 
		{
			cout << "Product, Cartesian:\t z1 * z2 = " << product1 << " - j " << abs(product2) << endl;
		}
		
		//Coverting Polar to Cartesian to verify results
		product5 = product3 * cos(product4);
		product6 = product3 * sin(product4);
		if (product6 > 0)
		{
			cout << "Polar, converted to Cartesian: z1 * z2 = " << product5 << " + j " << product6 << endl;
		}
		else
		{
			cout << "Polar, converted to Cartesian: z1 * z2 = " << product5 << " - j " << abs(product6) << endl;
		}
	}
	//Making an if-else statement to see if the user entered numbers for a polar coordinate or cartesian coordinate both times and to see if they want to represent vector or complex numbers.	
	...
	else if (((user7 == "c" || user7 == "C") && (user == "P" || user == "p") && (user2 == "c" || user2 == "C")))
	{
		...
		//Finding the product using polar values
		product3 = num1 * Radius2;			// Two Radius Values
		product4 = num2 + Theta2;			// Two Theta Angles
		cout << "\nProduct, polar:\t\t z1 * z2 = " << product3 << " exp(j " << product4 << endl;
		
		//Finding the product using Cartesian values
		product1 = ((x * num3) - (y * num4));		//z1*z2 = (x1x2 - y1y2) + j(x1y2 + y1x2)
		product2 = ((x * num4) + (y * num3));
	...
	else if (((user7 == "c" || user7 == "C") && (user == "P" || user == "p") && (user2 == "p" || user2 == "P")))
	{
		...
		//Finding the product using polar values
		product3 = num1 * num3;			// Two Radius Values
		product4 = num2 + num4;			// Two Theta Angles
		cout << "\nProduct, polar:\t\t z1 * z2 = " << product3 << " exp(j " << product4 << endl;
		
		//Finding the product using Cartesian values
		product1 = ((x * x2) - (y * y2));		//z1*z2 = (x1x2 - y1y2) + j(x1y2 + y1x2)
		product2 = ((x * y2) + (y * x2));
	...
	else if (((user7 == "c" || user7 == "C") && (user == "C" || user == "c") && (user2 == "p" || user2 == "P")))
	{
		...
		//Finding the product using polar values
		product3 = x * num3;			// Two Radius Values
		product4 = y + num4;			// Two Theta Angles
		cout << "\nProduct, polar:\t\t z1 * z2 = " << product3 << " exp(j " << product4 << endl;
		
		//Finding the product using Cartesian values
		product1 = ((num1 * x2) - (num2 * y2));		//z1*z2 = (x1x2 - y1y2) + j(x1y2 + y1x2)
		product2 = ((num1 * y2) + (num2 * x2));
