...
void Output(ofstream & out, double aMatrix[][4], double xValues[][1], double bValues[][1], double bMatrix[][1]);
void cramer(ofstream &out, double aMatrix[][DIM], double xValues[][1], double bMatrix[][1], double det, int n);
void mMult(ofstream & out, double aMatrix[][4], double xValues[][1], double bValues [][1], double bMatrix[][1]);
...
int main()
{
	...
	//Declaring Variables
	double xValues[4][1], bValues[4][1], det, newMatrix[DIM][DIM];
	int i = 0, j = 0, n = DIM;
	...
	mMult(out,aMatrix,xValues,bValues, bMatrix);
...
void Output(ofstream & out, double aMatrix[][4], double xValues[][1], double bValues[][1], double bMatrix[][1])
{
	...
	for (int g = 0; g < 4; g++)
	{
		//There is a * and a = only in the second row
		if(g == 1)
		{
			out << "[ " << setw(10) << aMatrix[g][0] << setw(10) << aMatrix[g][1] << setw(10) << aMatrix[g][2]  << setw(10) << aMatrix[g][3] << " ] * [ " << "x1" << " ] = [ " << setw(10) << bMatrix[g][0] << " ]\n";
		}
		else if (g == 0)
		{
			out << "[ " << setw(10) << aMatrix[g][0] << setw(10) << aMatrix[g][1] << setw(10) << aMatrix[g][2]  << setw(10) << aMatrix[g][3] << " ]   [ " << "x0" << " ]   [ " << setw(10) << bMatrix[g][0] << " ]\n";
		}
		else if (g == 2)
		{
			out << "[ " << setw(10) << aMatrix[g][0] << setw(10) << aMatrix[g][1] << setw(10) << aMatrix[g][2]  << setw(10) << aMatrix[g][3] << " ]   [ " << "x2" << " ]   [ " << setw(10) << bMatrix[g][0] << " ]\n";
		}
		else if (g == 3)
		{
			out << "[ " << setw(10) << aMatrix[g][0] << setw(10) << aMatrix[g][1] << setw(10) << aMatrix[g][2]  << setw(10) << aMatrix[g][3] << " ]   [ " << "x3" << " ]   [ " << setw(10) << bMatrix[g][0] << " ]\n";
		}
		else if (g == 4)
		{
			out << "[ " << setw(10) << aMatrix[g][0] << setw(10) << aMatrix[g][1] << setw(10) << aMatrix[g][2]  << setw(10) << aMatrix[g][3] << " ]   [ " << "x4" << " ]   [ " << setw(10) << bMatrix[g][0] << " ]\n";
		}
	}
...
void mMult(ofstream & out, double aMatrix[][4], double xValues[][1], double bValues [][1], double bMatrix[][1])
{
	...
	for (int i = 0; i < DIM; i++)
	{
			bValues[i][0] = aMatrix[i][0] * xValues[0][0] + aMatrix[i][1] * xValues[1][0] + aMatrix[i][2] * xValues[2][0] + aMatrix[i][3] * xValues[3][0];
	}
	...
	for (int g = 0; g < 4; g++)
	{
		if(g == 1)
		{
			out << "[ " << setw(10) << aMatrix[g][0] << setw(10) << aMatrix[g][1] << setw(10) << aMatrix[g][2]  << setw(10) << aMatrix[g][3] << " ] * [ " << setw(10) << xValues[g][0] << " ] = [ " << setw(10) << bValues[g][0] << " ]\n";
		}
		else if (g == 0)
		{
			out << "[ " << setw(10) << aMatrix[g][0] << setw(10) << aMatrix[g][1] << setw(10) << aMatrix[g][2]  << setw(10) << aMatrix[g][3] << " ]   [ " << setw(10) << xValues[g][0] << " ]   [ " << setw(10) << bValues[g][0] << " ]\n";
